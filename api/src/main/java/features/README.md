...
Cada módulo puede tener un `Main.java` para pruebas rápidas sin levantar toda la API. Por ejemplo:
```
cd src/main/java/features/filosofos
mvn exec:java -Dexec.mainClass=features.filosofos.Main
```